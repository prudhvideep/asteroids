...
(() => {
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/asteroid_2.png",
      "start": 0,
      "end": 57242
    }, {
      ...
      "filename": "/assets/background_copper.png",
      "start": 96963,
      "end": 117078
    }, {
      "filename": "/assets/game_loop.mp3",
      "start": 117078,
      "end": 2678358,
      "audio": 1
    }, {
      "filename": "/assets/laser.mp3",
      "start": 2678358,
      "end": 2685176,
      "audio": 1
    }, {
      "filename": "/assets/rock_destroyed.mp3",
      "start": 2685176,
      "end": 2744696,
      "audio": 1
    }, {
      "filename": "/assets/spaceship_blue.png",
      "start": 2744696,
      "end": 2824034
    }, {
      "filename": "/assets/spaceship_explosion.mp3",
      "start": 2824034,
      "end": 2944406,
      "audio": 1
    } ],
    "remote_package_size": 2944406
  });
})();

// end include: /tmp/tmpqkfwpigb.js
// include: /tmp/tmpafv2c1xh.js
...
// end include: /tmp/tmpafv2c1xh.js
// include: /tmp/tmpfky3w0nt.js
...
// end include: /tmp/tmpfky3w0nt.js
...
var ASM_CONSTS = {
  ...
  70862: () => Module.canvas.width,
  70894: () => parseInt(Module.canvas.style.width),
  70942: () => {
  ...
  71305: () => window.innerWidth,
  71331: () => window.innerHeight,
  71358: () => {
    if (document.fullscreenElement) return 1;
  },
  71404: () => Module.canvas.width,
  71436: () => parseInt(Module.canvas.style.width),
  71484: () => {
    if (document.fullscreenElement) return 1;
  },
  71530: () => Module.canvas.width,
  71562: () => screen.width,
  71587: () => window.innerWidth,
  71613: () => window.innerHeight,
  71640: () => {
    if (document.fullscreenElement) return 1;
  },
  71686: () => Module.canvas.width,
  71718: () => screen.width,
  71743: () => {
    document.exitFullscreen();
  },
  ...
  71816: () => Module.canvas.width,
  71848: () => parseInt(Module.canvas.style.width),
  71896: () => {
    document.exitFullscreen();
  },
  71923: $0 => {
  ...
  71961: () => screen.width,
  71986: () => screen.height,
  72012: () => window.screenX,
  72039: () => window.screenY,
  72066: () => window.devicePixelRatio,
  72102: $0 => {
  ...
  72596: () => window.innerWidth,
  72622: () => window.innerHeight,
  72649: () => {
  ...
  75018: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  75122: () => {
    try {
  ...
  78121: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
  78187: $0 => {
